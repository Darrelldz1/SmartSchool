...
export default function Teacher() {
  ...
  return (
    <div className="teacher-page" style={{ backgroundColor: '#f8fafc' }}>
      <Header />
      ...
      <div className="teacher-container">
        <div className="teacher-wrapper">
          ...
          {loading ? (
            ...
            <div className="teacher-empty"></div>
          ) : (
            <div className="teacher-grid">
              {teachers.map((t) => (
                <div key={t.id} className="teacher-card" onClick={() => openDetail(t)}>
                  <div className="teacher-avatar">
                    {imageUrlFor(t) ? (
                      <img src={imageUrlFor(t)} alt={t.name} />
                    ) : (
                      <div className="teacher-avatar-placeholder">{getInitials(t.name)}</div>
                    )}
                  </div>
        ...
        <div className="modal-overlay" onClick={closeDetail}>
          <div className="modal-content" onClick={(e) => e.stopPropagation()}>
            <div className="modal-header">
              <h2>{selected.name}</h2>
              <button onClick={closeDetail} className="close-button">Tutup</button>
            </div>
              ...
              <div style={{ display: "flex", justifyContent: "center", marginBottom: "1.5rem" }}>
                <div className="teacher-avatar" style={{ width: 180, height: 180 }}>
                  {imageUrlFor(selected) ? (
                    ...
                    <div className="teacher-avatar-placeholder" style={{ fontSize: "4.5rem" }}>
