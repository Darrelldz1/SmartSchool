...
import Headmaster from "./components/Headmaster"; // Tambah
...
export default function App() {
  return (
    <Routes>
      ...
      <Route path="/pengumuman" element={<Listpengumuman />} /> {/* Route baru untuk list */}
      <Route path="/pengumuman/:id" element={<PengumumanDetail />} /> {/* Route dengan parameter */}
      ...
      >
        ...
        <Route path="PengumumanAdmin" element={<PengumumanAdmin />} />
        <Route path="PengumumanForm" element={<PengumumanForm />} />
        <Route path="pengumuman/:id/edit" element={<PengumumanForm />} /> {/* Route edit pengumuman */}
